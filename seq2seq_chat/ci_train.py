...
with io.open('./data/tencent_chat_q.txt', 'r', encoding='utf-8') as f:
    source_data = f.read()
...
save_vocab(source_letter_to_int, './data/src_dict_tencent_chat_ci.txt')
save_vocab(target_letter_to_int, './data/tgt_dict_tencent_chat_ci.txt')
...
target_int = [[target_letter_to_int.get(letter, target_letter_to_int['<UNK>'])
               for letter in line.split()] + [target_letter_to_int['<EOS>']] for line in target_data.split('\n')]
...
checkpoint = "./model/tencent_chat_ci.ckpt"
